...
public:
   ...
   */
  void run(std::vector<int> &v1, std::vector<int> &v2, const std::string &name, 
...
void demoDetector<TVocabulary, TDetector, TDescriptor>::run
  (std::vector<int> &index1, std::vector<int> &index2, const std::string &name, const FeatureExtractor<TDescriptor> &extractor)
{
